  ...
  return (
    <section id='faq' className='px-auto mt-44'>
        <div className='max-w-3xl mx-auto'>
                ...
                <Animated delay={0.2} >
                    <h2 className="text-4xl md:text-5xl max-w-2xl mx-auto text-balance">Frequently Asked Questions</h2>
                </Animated>
           </div>
                        ...
                        {faqs.map((faq,index)=>(
                              <Animated key={index} y={150} delay={index*0.15}>
                                   <details className='border border-slate-200 text-zinc-500 rounded-lg group'>
                                        <summary className='flex item-center justify-between p-4 cursor-pointer list-none hover:bg-slate-50/50 transition-colors[&::-webkit-details-marker]:hidden'>
                                          <span className='text-zinc-700'>{faq.question}</span>
