  ...
  return (
    <section id='testimonial' className='px-auto mt-44'>
            ...
            <div className="text-center mb-16">
                <Animated delay={0.2} >
                    <p className="text-orange-500 font-medium uppercase mb-3.5">Loved By food Lovers</p>
                </Animated>
                <Animated delay={0.2}>
                    <h2 className="text-4xl md:text-5xl max-w-lg mx-auto text-balance">Discover Our Guests Say</h2>
                             ...
                             <Animated key={index} y={80} delay={index*0.1} className="border border-slate-200 hover:bg-slate-50/50 rounded-2xl p-6 flex flex-col justify-between text-left">
                                   <div>
                                    ...
                                    <div className='flex items-center gap-3 mt-auto'>
                                        <img src={item.avatar} alt={item.name} className="size-11 rounded-full object-cover shrink-0"></img>
                                         <div>
