  ...
  return (
    <section id='dishes' className='px-auto mt-44'>
           <div className="text-center mb-16">
                ...
                <Animated >
                    <h2 className="text-4xl md:text-5xl max-w-lg mx-auto text-balance">Discover our sitgnature dishes</h2>
                </Animated>
           </div>
           ...
           <div className="grid grid-cols-2 md:grid-cols-4 gap-12 md:gap-18 max-w-5xl mx-auto">
                    {dishes.map((dish,index)=>(
                        <Animated key={index} y={80} delay={index*0.1} className="flex flex-col items-center text-center shrink-0 cursor-pointer" onMouseEnter={()=>setRotate((prev)=>({...prev,[index]:prev[index]|| 0+180}))} onMouseLeave={()=>setRotate((prev)=>({...prev,[index]:0}))}>
