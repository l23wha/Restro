    ...
    <nav className={`fixed top-0 z-20 px-auto w-full transition-all duration-300 ${scrolled? 'bg-white/70 backdrop-blur-md':'bg-transparent'}  `}>
         ...
         <div className="flex items-center justify-between font-medium py-4 mx-auto max-w-7xl">
                        <a href="/">
                         ...
                         <div className="hidden space-x-6 md:flex items-center gap-10">
                            {navLinks.map((link) => (
                        ...
                        <button onClick={() => setMobileOpen(true)} className='md:hidden bg-zinc-800 text-white p-2 rounded-md aspect-sqaure '>
                            <MenuIcon/>
                        </button>
     ...
     {/* {Mobile navigation drawer} */}
       ...
       <div className={`flex flex-col items-center p-8 fixed inset-0 bg-white/70 backdrop-blur-md z-40 transform transition duration-300 ${mobileOpen ? 'translate-x-0' : 'translate-x-full'}`}>
